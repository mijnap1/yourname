jQuery(function($) {
    ...
    window.ScrollEffects = function() {
        ...
        if (isMobile()) {
            ...
            $('.smooth-scroll main, .has-parallax, nav, .yourname-slider-wrapper:not(.content-slider), .showcase-lists .yourname-sync-slider, .next-project-image-wrapper, .slider-fixed-content').css({
                'height': winHeight
            });
        ...
        if ($('#yourname-page-content').hasClass("light-content")) {
            if ($('#project-nav').hasClass("change-header")) {
                imagesLoaded('body', function() {
                    setTimeout(function() {
                        var pageNav = document.querySelector('#project-nav.change-header');
                        if (pageNav) {
                            var pageContent = document.querySelector('#yourname-page-content');
                            var nextPageCaptionParallax = gsap.to('.page-nav-caption', {
                                scrollTrigger: {
                                    trigger: pageNav,
                                    start: "top 8%",
        ...
        if ($('#yourname-page-content').hasClass("dark-content")) {
            if ($('#project-nav').hasClass("change-header")) {
                imagesLoaded('body', function() {
                    setTimeout(function() {
    ...
    window.FirstLoad = function() {
        ...
        if ($("#yourname-page-content").hasClass("light-content")) {
            ...
            gsap.to("main", {
                duration: 0.5,
                backgroundColor: document.querySelector("#yourname-page-content").getAttribute("data-bgcolor"),
                ease: Power2.easeInOut
            });
                    ...
                    $body.on('mouseup mousemove', function handler(evt) {
                        if (evt.type === 'mouseup') {
                            ...
                            $('#itemsWrapperLinks .trigger-item-link, #itemsWrapperLinks .trigger-item-link-secondary').on('click', function() {
                                ...
                                if (!$('#yourname-page-content').hasClass("light-content")) {
                                    ...
                                    if (!$('.portfolio').hasClass("portfolio-shortcode")) {
                                        if (!parent_item.hasClass("change-header")) {
                                            $('#yourname-page-content').delay(1200).queue(function(next) {
                                ...
                                $('.yourname-slider .trigger-item').each(function() {
        ...
        if (!$("body").hasClass("disable-ajaxload")) {
            ...
            if ($("#itemsWrapper").hasClass("no-fitthumbs")) {
                ...
                $('#itemsWrapperLinks .trigger-item-link').on('click', function() {
                    ...
                    const fadeOutTargets = $('#hero, #show-filters, .yourname-slider, .item, .item-caption-wrapper, #page-nav, footer, .fadeout-element');
                    const ball = $('#ball');
    ...
    window.Sliders = function() {
        ...
        if ($('.content-slider').length > 0) {
            ...
            slider = new yournameSlider('.content-slider', {
            ...
            $(".slider-button-prev").mouseenter(function(e) {
                if ($(this).parents(".yourname-slider-wrapper").hasClass("light-cursor")) {
                ...
                } else if ($(this).parents(".yourname-slider-wrapper").hasClass("dark-cursor")) {
            ...
            $('.content-slider.looped-carousel .yourname-slider, .content-slider.small-looped-carousel .yourname-slider').on('mouseenter mousemove', function() {
    ...
    window.Lightbox = function() {
        ...
        function showDetails(item) {
            ...
            $('body').prepend(`<div class="yourname-img-popup">
				<div class="yourname-img-popup-bg-close"></div>				
				<div class="yourname-img-popup-viewport">
					<div class="yourname-img-popup-preloader"><div></div><div></div><div></div><div></div></div>					
					<img />
					<div class="yourname-img-popup-close link"></div>						
				</div>				
				<div class="yourname-img-popup-prev link"></div>
				<div class="yourname-img-popup-next link"></div></div>`);

            const details = document.querySelector('.yourname-img-popup');
            const detailsBgClose = document.querySelector('.yourname-img-popup-bg-close');
            const detailsClose = document.querySelector('.yourname-img-popup-close');
            const detailsPreloader = document.querySelector('.yourname-img-popup-preloader');
            const detailImage = document.querySelector('.yourname-img-popup img');
            const detailPrev = document.querySelector('.yourname-img-popup-prev');
            const detailNext = document.querySelector('.yourname-img-popup-next');
        ...
        function showVideoDetails(event, item) {
            ...
            $('body').prepend(`<div class="yourname-video-popup">
				<div class="yourname-video-popup-bg-close"></div>				
				<div class="yourname-video-popup-viewport">
					<div class="yourname-video-popup-preloader"><div></div><div></div><div></div><div></div></div>					
					<iframe class="yourname-video-popup-iframe" frameborder="0" allow="autoplay"></iframe>
					<div class="yourname-video-popup-close link"></div>						
				</div>				
				<div class="yourname-img-video-prev link"></div>
				<div class="yourname-img-video-next link"></div></div>`);

            const details = document.querySelector('.yourname-video-popup');
            const detailsBgClose = document.querySelector('.yourname-video-popup-bg-close');
            const detailsClose = document.querySelector('.yourname-video-popup-close');
            const detailsPreloader = document.querySelector('.yourname-video-popup-preloader');
            const detailIframe = document.querySelector('.yourname-video-popup iframe');
    ...
    window.Core = function() {
        ...
        if (!isMobile() && !$('body').hasClass("disable-cursor")) {
            ...
            $(".yourname-button .sticky.left").mouseenter(function(e) {
                var rcBounds = $(this)[0].getBoundingClientRect();
            ...
            $(".yourname-button .sticky.right").mouseenter(function(e) {
                var rcBounds = $(this)[0].getBoundingClientRect();
            ...
            $(".yourname-button .parallax-wrap.icon-wrap").mouseenter(function(e) {
                gsap.to(ball, {
                    duration: 0.05,
                    scale: 0.4,
                    borderWidth: '0px',
            ...
            $(".yourname-button .sticky").mouseenter(function(e) {
                if ($('#yourname-page-content').hasClass("light-content")) {
                    gsap.to(ball, {
                        duration: 0.5,
                        borderColor: '#000'
            ...
            $(".yourname-button .parallax-wrap").mouseenter(function(e) {
                if ($('#yourname-page-content').hasClass("light-content")) {
                    gsap.to(ball, {
                        duration: 0.05,
                        borderColor: '#000'
            ...
            //Blog Hover Effects			
            $("#blog-page-nav .page-numbers li a, .post-page-numbers, #post-content a, #post-form a, #post-comments a, .wp-block-search__button, .yourname-sidebar-widget a").mouseenter(function(e) {
                gsap.to('#ball', {
                    duration: 0.2,
                    borderWidth: '1px',
                    scale: 1,
            ...
            $("#blog-page-nav .page-numbers li a, .post-page-numbers, #post-content a, #post-form a, #post-comments a, .wp-block-search__button, .yourname-sidebar-widget a").mouseleave(function(e) {
                gsap.to('#ball', {
                    duration: 0.3,
                    borderWidth: '4px',
                    scale: 0.5,
        ...
        jQuery(document).ready(function() {
            ...
            function loadNewContent(url, bool) {
                ...
                section.load(url + ' .cd-main-content > *', function(event) {
                    ...
                    var yourname_title = event.match(/<title[^>]*>([^<]+)<\/title>/)[1];
                    $('head title').html(yourname_title);

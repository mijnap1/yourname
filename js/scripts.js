jQuery(function($) {
    ...
    function CleanupBeforeAjax() {
        ...
        yournameSlider.instances.forEach(slider => slider.off());
        yournameSlider.instances = [];
    }
        ...
        function initOnFirstLoad() {
            ...
            imagesLoaded('body', function() {
                ...
                setTimeout(function() {
                    ...
                    gsap.set($(".showcase-gallery .yourname-slider .slide-inner"), {
                        opacity: 0
                    });
                    gsap.to($(".showcase-gallery .yourname-slider .yourname-slide .slide-inner"), {
                        duration: 2,
                        opacity: 1,
                        delay: 0.3,
                        ease: Power4.easeOut
                    ...
                    var gallerySlideClasses = [".yourname-slide-prev-two", ".yourname-slide-prev", ".yourname-slide-active", ".yourname-slide-next", ".yourname-slide-next-two"];

                    gallerySlideClasses.forEach(function(gallerySlideClass, index) {
                        var gallerySlide = $(".showcase-gallery .yourname-slider " + gallerySlideClass + " .slide-inner");
                    ...
                    gsap.set($("#filters-wrapper, .yourname-pagination, .cp-button-prev, .cp-button-next, .progress-info, footer .link-text"), {
                        opacity: 0
                    });
                    gsap.to($("#filters-wrapper, .yourname-pagination, .cp-button-prev, .cp-button-next, .progress-info, footer .link-text"), {
                        duration: 0.4,
                        opacity: 1,
                        delay: 0.8,
                        ease: Power3.easeOut
    ...
    function ShowcasePortfolio() {
        ...
        if ($('.showcase-portfolio').length > 0) {
            ...
            function filter() {
                var state = Flip.getState('.yourname-item');
                var projects = document.querySelectorAll('.yourname-item');
                var startHeight = gsap.getProperty(".showcase-portfolio", "height");

                var filters = document.querySelectorAll('.filter-option.is_active');
                var parallaxItems = document.querySelectorAll('.showcase-portfolio .yourname-item.vertical-parallax .slide-inner');
            ...
            if (!isMobile()) {
                ...
                $(".showcase-portfolio .yourname-item .slide-inner").on('mouseenter', function() {
                    $('#ball p').remove();
                    var $this = $(this);
                    gsap.to('#ball', {
                        duration: 0.3,
    ...
    function ShowcaseGallery() {
        ...
        if ($('.showcase-gallery').length > 0) {
            ...
            slider = new yournameSlider('.showcase-gallery', {
                ...
                on: {
                    ...
                    slideLeaveViewport: function(slide) {
                        gsap.set($('.yourname-slider div:not(.yourname-slide-visible) .slide-events'), {
                            x: ""
                        });
                    },
            ...
            const showGrid = () => {
                ...
                gsap.to($("footer .link-text, .yourname-pagination, .progress-info, #filters-wrapper"), {
                    duration: 0.3,
                    opacity: 0,
                    y: 30,
                    stagger: -0.05,
                ...
                gsap.set(currentImage.closest(".yourname-slide"), {
                    zIndex: 0
                });
                ...
                gsap.to(".yourname-slider .yourname-slide .trigger-item", {
                    duration: 1,
                    opacity: 0,
                    scale: 0.7,
                    ease: Power2.easeOut
            ...
            const hideGrid = () => {
                ...
                Flip.from(flipstate1, {
                    ...
                    onComplete: function() {
                        ...
                        const triggeredItem = document.querySelector('.yourname-slide.triggered-item');
                        if (triggeredItem != null) {
                            triggeredItem.classList.remove('triggered-item');
                        }

                        const yournameSlides = document.querySelectorAll('.yourname-slide');
                        yournameSlides.forEach(slide => {
                            slide.style.zIndex = '';
            ...
            const getDOMElements = () => {
                ...
                const items = [];
                [...document.querySelectorAll('.yourname-slide')].forEach(item => {
                    items.push(new Item(item));
                });

                // Cloned items
                const itemsCloned = [];
                [...document.querySelectorAll('.yourname-slide-clone')].forEach(item => {
                ...
                return {
                    items: items,
                    grid: gridItems,
                    currentItem: new Item(document.querySelector('.yourname-slide.triggered-item')),
            ...
            const initEvents = () => {
                ...
                items.forEach((triggerItem) => {
                    ...
                    triggerItem.addEventListener('click', (event) => {
                        ...
                        if ($('.showcase-gallery').length > 0) {
                            ...
                            event.currentTarget.closest('.yourname-slide').classList.add('triggered-item');
                            showGrid();
                        }
                    });
                ...
                function moveThumbGrid(direction = "next") {
                    ...
                    if (document.body.classList.contains("grid-open")) {
                        ...
                        // Get all the slides
                        let slides = document.querySelectorAll('.yourname-slide');
                        ...
                        $('.yourname-slide').removeClass('triggered-item');
            ...
            if (!isMobile()) {
                ...
                if ($('.showcase-gallery').hasClass("tilt-gallery")) {
                    ...
                    function callTiltSlider(e) {
                        moveItSlider(e, '.yourname-slider-viewport', 30);
                    }
                ...
                var dragWrapper = $('.yourname-slider');
                ...
                $('.yourname-slider').on('mouseup touchend', function() {
                    gsap.to('#ball', {
                        duration: 1,
                        borderWidth: '4px',
                        scale: 0.5,
                ...
                $(".showcase-gallery.preview-mode-enabled .yourname-slide .slide-inner").on('mouseenter', function() {
